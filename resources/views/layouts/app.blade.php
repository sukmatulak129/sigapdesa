...
<body class="bg-gray-50">
    ...
    <div class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-blue-900 text-white">
        <div class="sidebar-content">
            ...
            <nav class="mt-8">
                <a href="{{ route('dashboard') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('dashboard') ? 'bg-blue-800' : '' }} relative">
                ...
                <a href="{{ route('peta') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('peta') ? 'bg-blue-800' : '' }}">
                    <i class="fas fa-map mr-3"></i> Peta Interaktif
                </a>
                
                @if(!auth()->user()->isAdmin())
                <a href="{{ route('laporan.create') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('laporan.create') ? 'bg-blue-800' : '' }}">
                    <i class="fas fa-plus-circle mr-3"></i> Buat Laporan
                </a>
                @endif
                
                <a href="{{ route('laporan.saya') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('laporan.saya') ? 'bg-blue-800' : '' }}">
                    <i class="fas fa-history mr-3"></i> {{ auth()->user()->isAdmin() ? 'Riwayat Laporan' : 'Laporan Saya' }}
                </a>
                
                @if(auth()->user()->isAdmin())
    <a href="{{ route('laporan.index') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('laporan.index') ? 'bg-blue-800' : '' }}">
        <i class="fas fa-tasks mr-3"></i> Kelola Laporan
    </a>
    <a href="{{ route('faq.index') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('faq.*') ? 'bg-blue-800' : '' }}">
        <i class="fas fa-question-circle mr-3"></i> FAQ
    </a>
    <a href="{{ route('anggaran.index') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('anggaran.*') ? 'bg-blue-800' : '' }}">
        <i class="fas fa-coins mr-3"></i> Anggaran
    </a>
    @endif
                
                <a href="{{ route('transparansi.index') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('transparansi.*') ? 'bg-blue-800' : '' }}">
                    <i class="fas fa-chart-pie mr-3"></i> Transparansi
                </a>
                <a href="{{ route('chatbot.index') }}" class="block py-3 px-6 hover:bg-blue-800 {{ request()->routeIs('chatbot.index') ? 'bg-blue-800' : '' }}">
        ...
        <div class="sidebar-bottom p-4">
            <div class="flex items-center">
                <img src="{{ auth()->user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=1e40af&color=ffffff' }}" 
            ...
            <form action="{{ auth()->user()->role == 'admin' ? route('admin.logout') : route('logout') }}" 
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-200">
                        @auth
                            {{ auth()->user()->isAdmin() ? 'Mode Admin' : 'Mode Warga' }}
                        @else
                            Mode Tamu
                        @endauth
                    </p>
